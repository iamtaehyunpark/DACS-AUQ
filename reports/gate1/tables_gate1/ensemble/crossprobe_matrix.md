...
| **Qwen3.5-4B** | — | — | — | 0.657 *(self)* | — | — | — | — |
| **Qwen3.5-9B** | — | — | — | — | 0.715 *(self)* | — | — | — |
...
| **Qwen3.5-4B** | — | — | — | 0.815 *(self)* | — | — | — |
| **Qwen3.5-9B** | — | — | — | — | 0.823 *(self)* | — | — |
...
| **Qwen3.5-4B** | — | — | — | 0.803 *(self)* | — | — | — |
| **Qwen3.5-9B** | — | — | — | — | 0.793 *(self)* | — | — |
...
| **Qwen3.5-4B** | — | — | — | 0.792 *(self)* | — | — | — |
| **Qwen3.5-9B** | — | — | — | — | 0.813 *(self)* | — | — |
...
| alfworld | Mistral-7B-Instruct-v0.3 | SPLIT-action | Mistral-7B-Instruct-v0.3 | 0.015 | [0.003, 0.033] |
| alfworld | Mistral-7B-Instruct-v0.3 | SPLIT-action | Phi-4-mini-instruct | 0.016 | [0.000, 0.033] |
...
| alfworld | Mistral-7B-Instruct-v0.3 | SPLIT-action | gemma-3-4b-it | 0.000 | [0.000, 0.009] |
...
| alfworld | Phi-4-mini-instruct | SPLIT-thought | Qwen3.6-35B-A3B | 0.064 | [0.043, 0.085] |
| alfworld | Phi-4-mini-instruct | SPLIT-thought | deepseek-v4-flash | 0.013 | [0.000, 0.041] |
| alfworld | Phi-4-mini-instruct | SPLIT-thought | gemma-3-4b-it | 0.008 | [0.000, 0.032] |
| alfworld | Qwen3.5-4B | SPLIT-action | Qwen3.5-4B | 0.000 | [0.000, 0.006] |
| alfworld | Qwen3.5-9B | SPLIT-action | Qwen3.5-9B | 0.000 | [0.000, 0.006] |
...
| alfworld | deepseek-v4-flash | SPLIT-thought | deepseek-v4-flash | 0.000 | [0.000, 0.001] |
...
| alfworld | gemma-3-4b-it | SPLIT-action | deepseek-v4-flash | 0.000 | [0.000, 0.016] |
...
| hotpotqa | Qwen3.6-35B-A3B | SPLIT-action | Qwen3.6-35B-A3B | 0.007 | [0.000, 0.015] |
